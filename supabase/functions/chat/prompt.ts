...
3. Once the important requirements are understood, return a thoughtful, standalone Markdown plan. Its very first characters must be exactly one H1 heading ("# ...") so Shader Studio can recognize it immediately.
